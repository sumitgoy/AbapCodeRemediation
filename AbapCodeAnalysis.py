...
def lambda_handler(event, context):
    ...
    prompt = f"""
    Analyze the following ABAP code to identify any deprecated or changed elements based on the latest SAP S/4HANA 
    Simplification List of 2023. Ensure the output of the program remains unchanged while addressing these elements. 
    
    Provide the results in a JSON object "Code Changes" with the following fields for each identified issue:
    - Priority: High, Medium, or Low
    - Line Number: Excat numbers seprated by comma. Where the issue occurs
    - Correction Title: Brief description of the issue
    - Correction Message: Detailed description of what needs to be corrected
    - Suggestion Accuracy: Probability percentage of the suggested correction being accurate
    - Summary: A concise summary of the suggested correction
